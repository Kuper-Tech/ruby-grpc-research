...
run do |env|
  # Async::HTTP::Internet.post("http://localhost:50051") do |response|
  ...
  response = active_call.request_response("", metadata: {})

  [200, { 'Content-Type' => 'application/grpc+proto', 'grpc-encoding' => 'gzip' }, [""]]
end
